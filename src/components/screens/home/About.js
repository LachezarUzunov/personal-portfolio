...
import { FaAngular, FaCpanel, FaCss3, FaNode, FaNodeJs, FaReact, FaWordpressSimple } from "react-icons/fa";
      ...
      <div className={classes.about__section}>
        ...
        <div>
          <p>
            ...
            one of the largest hosting services providers. I've helped over 60
            000 clients with WordPress issues,{" "}
          </p>
          <h3>My Tech Stack</h3>
          <Line />
